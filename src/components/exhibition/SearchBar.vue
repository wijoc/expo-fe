  ...
  <header id="exhibition-bar" ref="exhibition-bar" class="flex flex-row justify-center items-center gap-2 px-1.5 fixed w-full z-50 bg-white sm:top-5 sm:px-8 md:px-6 lg:px-[4.5rem] xl:px-[5.5rem]">
    ...
    <div id="search-bar" class="flex w-full gap-1 px-1 py-2 flex-nowrap">
      <div class="relative flex items-center justify-start min-w-full gap-0 p-0 overflow-hidden border-2 rounded-md flex-nowrap border-secondary focus-within:border-primary">
        ...
        <input type="text" :class="'w-[90%] p-[.2rem] text-sm bg-white placeholder:text-gray-400 focus:outline-none ' + (this.shopSearch ? 'rounded-r' : 'rounded')" placeholder="Cari Barang ..." v-model="keyword">
