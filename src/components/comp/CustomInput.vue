<template>
  <div :class="this.inputAttr.divClass" v-show="!this.inputAttr.hidden">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="cursor-pointer text-gray-400 fill-current w-5 h-5 absolute right-2 top-[2.35rem] hover:text-gray-600"
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="cursor-pointer text-gray-400 fill-current w-5 h-5 absolute right-2 top-[2.35rem] hover:text-gray-600"
