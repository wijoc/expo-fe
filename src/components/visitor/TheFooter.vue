<template>
  <footer class="min-h-full bottom-0">
    <section class="bg-gray-800 py-5">
      <div class="container flex flex-col flex-wrap sm:flex-row sm:flex-nowrap">
        <div class="w-full text-white mb-5 sm:w-1/2">
          <span class="w-full border-b-2 border-white uppercase py-1">
            UMKM Expo
          </span>
          <p class="w-full text-justify mt-5 mb-5 leading-none">
            Hadir sebagai saran bagi pelaku UMKM dan UKM pada masa pandemi
          </p>
          <table class="w-full table-auto border-collapse text-base mb-5">
            <tr>
              <td class="pr-2">Telepone</td>
              <td>:</td>
          ...
          <div class="flex flex-row flex-wrap justify-start gap-2">
            <a href="https://www.instagram.com/" class="w-fit max-h-10 bg-white rounded p-1">
            ...
            <a href="https://www.youtube.com/" class="w-fit max-h-10 bg-white rounded p-1">
            ...
            <a href="https://www.facebook.com/" class="w-fit max-h-10 bg-white rounded p-1">
            ...
            <a href="https://www.twitter.com/" class="w-fit max-h-10 bg-white rounded p-1">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-8 h-8 sm:mb-3">
                <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
        ...
        <div class="w-full flex flex-col text-white sm:w-1/2">
          <p class="underline underline-offset-2 mb-5">Useful Link</p>
          ...
          <a href="pameran.html" class="flex flex-row">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" class="w-6 h-6 fill-white">
              <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
              <path d="M246.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6l0 256c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l128-128z"/>
            </svg>
          ...
          <a href="faq.html" class="flex flex-row">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" class="w-6 h-6 fill-white">
              <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
              <path d="M246.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6l0 256c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l128-128z"/>
            </svg>
          ...
          <a href="stream.html" class="flex flex-row">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" class="w-6 h-6 fill-white">
              <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
              <path d="M246.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6l0 256c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l128-128z"/>
            </svg>
          ...
          <a href="registration.html" class="flex flex-row">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" class="w-6 h-6 fill-white">
              <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
              <path d="M246.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6l0 256c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l128-128z"/>
            </svg>
          ...
          <a href="Login.html" class="flex flex-row">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" class="w-6 h-6 fill-white">
              <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
              <path d="M246.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-9.2-9.2-22.9-11.9-34.9-6.9s-19.8 16.6-19.8 29.6l0 256c0 12.9 7.8 24.6 19.8 29.6s25.7 2.2 34.9-6.9l128-128z"/>
            </svg>
    ...
    <section class="bg-black text-center text-white">
      Zoe - September 2022 - TailwindCSS
    </section>
  </footer>
</template>
